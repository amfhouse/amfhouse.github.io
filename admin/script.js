...
(function() {
  ...
  var prompt = "> ",
    self = document.getElementById("amf_terminal"),
    commands = {
      "amfhouse": function() {
...
"░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░"]
        ...
        logs = amfhouse[Math.floor(Math.random() * amfhouse.length)];
        for (var i = 0, l = logs.length; i < l; i++)
          setTimeout(function(n) {
            log(logs[n]);
          }, i * 100, i);
        setTimeout(function() {
          animatedLog("> Did that work? ", "#00FF00", "animatedIntroMessage10", function() {
            animatedLog("> Oh well, maybe the page is lost forever.", "#00FF00", "animatedIntroMessage11", function() {
              animatedLog("> If you believe this is a problem, try contacting the server administer.", "#00FF00", "animatedIntroMessage12", function() {
                animatedLog("> He like amfhouse too!", "#00FF00", "animatedIntroMessage13", function() {
                  newline();
                }, 400, 1000);
              }, 1400, 1000);
            }, 800, 1000);
...
"░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░"]
        ...
        logs = amfhouse2[Math.floor(Math.random() * amfhouse2.length)];
        for (var i = 0, l = logs.length; i < l; i++)
          setTimeout(function(n) {
            log(logs[n]);
          }, i * 100, i);
        setTimeout(function() {
          animatedLog("> Did that work? ", "#00FF00", "animatedIntroMessage36", function() {
            animatedLog("> Oh well, maybe the page is lost forever.", "#00FF00", "animatedIntroMessage37", function() {
              animatedLog("> If you believe this is a problem, try contacting the server administer.", "#00FF00", "animatedIntroMessage38", function() {
                animatedLog("> He like amfhouse too!", "#00FF00", "animatedIntroMessage39", function() {
                  newline();
                }, 400, 1000);
              }, 1400, 1000);
            }, 800, 1000);
...
"░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░"]
  ...
  function log(txt, color, id) {
    var node = document.createElement("p");
    node.style.color = color || "#d101fe";
    node.innerHTML = txt.toUpperCase();
    node.setAttribute("class", "amfresponse");
    if (id != undefined)
  ...
  function handler(input) {
    if (commands[input.split(" ")[0]] == undefined) {
      log('Да Вы что!? Ответ неверный!!!', "#FF0000");
      newline();
    } else {
  ...
  function init() {
    animatedLog("> Вот ты и попался, засранец! Что ты здесь, в ../admin/ забыл?.", "#00FF00", "animatedIntroMessage1", function() {
      window.setTimeout(function() {
        animatedLog("> Это не место для случайных любителей изменять своё сознание!", "#00FF00", "animatedIntroMessage2", function() {
			        animatedLog("> Но раз уж ты здесь, ничего не поделаешь. Разнюхал как-то...", "#00FF00", "animatedIntroMessage23", function() {
						        animatedLog("> Попробуй ответить на вопрос: Какой в Украине rs-шоп лучший?", "#00FF00", "animatedIntroMessage24", function() {
									        animatedLog("> Пиши латинскими, система буржуйская, не поймёт кириллицу.", "#00FF00", "animatedIntroMessage25", function() {
          newline();
        }, 1000, 1500);
		}, 1000, 1500);
		}, 1000, 1500);   
